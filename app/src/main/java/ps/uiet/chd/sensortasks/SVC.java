...
public class SVC
{
    ...
    public static int main(String[] args, String[] vectorData)
    {
        if (args.length == 100)
        {
            if(vectorsString==null)
            {
                System.out.print("executed");
                vectorsString = vectorData;
            }
            // Features:
            ...
            double[][] vectors = new double[rows][columns];
            double[][] coefficients = {};
            double[] intercepts = {-0.5198351907376304, 2.523852019865944, -0.7643337896333549, 0.9910386552080536, -0.4610537157808618, -0.985617407360013};
            int[] weights = {80, 76, 8, 101};

            // Prediction:
            SVC clf = new SVC(4, 4, vectors, coefficients, intercepts, weights, "rbf", 0.01, 0.0, 3);
